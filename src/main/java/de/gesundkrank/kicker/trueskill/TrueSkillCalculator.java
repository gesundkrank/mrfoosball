...
public abstract class TrueSkillCalculator {
    ...
    static ITeam toTeam(final IPlayer trueSkillPlayer1,
                        final de.gesundkrank.kicker.models.Player player1,
                        final IPlayer trueSkillPlayer2,
                        final de.gesundkrank.kicker.models.Player player2) {
    ...
    public static List<de.gesundkrank.kicker.models.Player> getBestMatch(
            final List<de.gesundkrank.kicker.models.Player> playerList
    ) {
        ...
        final List<de.gesundkrank.kicker.models.Player> bestMatch = new LinkedList<>();
    ...
    private static double calcMatchQuality(final de.gesundkrank.kicker.models.Team teamA,
                                           final de.gesundkrank.kicker.models.Team teamB) {
