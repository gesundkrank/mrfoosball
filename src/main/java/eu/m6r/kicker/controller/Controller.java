...
package eu.m6r.kicker.controller;
...
import eu.m6r.kicker.PlayerQueues;
...
public class Controller {
    ...
    public synchronized void finishTournament(final String channelId,
            ...
            throws InvalidTournamentStateException, IOException,
                   RunningTournaments.TournamentNotRunningException {
    ...
    public Tournament getRunningTournament(final String channelId)
            throws IOException, RunningTournaments.TournamentNotRunningException {
    ...
    public void newMatch(final String channelId)
            throws InvalidTournamentStateException,
                   RunningTournaments.TournamentNotRunningException, IOException {
    ...
    public void scoreTeamA(final Tournament runningTournament) {
    ...
    public static class Binder extends AbstractBinder {
        ...
        protected void configure() {
            try {
                ...
                LogManager.getLogger().error("Failed to create controller.", e);
